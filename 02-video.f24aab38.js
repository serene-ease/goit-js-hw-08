...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("#vimeo-player"),i=new Vimeo.Player(o),r="video-time-point",n=JSON.parse(localStorage.getItem("video-time-point"));i.setCurrentTime(n),i.on("timeupdate",(0,e.default)(function(e){localStorage.setItem("video-time-point",JSON.stringify(e.seconds))},1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.f24aab38.js.map